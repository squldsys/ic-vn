...
<template>
  <VRow>
    <VCol cols="12">
      <AppCardCode title="Basic" :code="demoCode.basic" no-padding>
        <DemoSimpleTableBasic />
      </AppCardCode>
    </VCol>

    <VCol cols="12">
      <AppCardCode title="Theme" :code="demoCode.theme" no-padding>
        <VCardText>
    ...
    <VCol cols="12">
      <AppCardCode title="Fixed Header" :code="demoCode.fixedHeader" no-padding>
        <VCardText>
