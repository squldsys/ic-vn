export default [
  { heading: '広告管理' },
  {
    ...
    icon: { icon: 'tabler-ad' },
    children: [
      { title: '広告管理', to: 'forms-autocomplete' },
      { title: '広告設定', to: 'forms-checkbox' },
      { title: 'CV設定', to: 'forms-combobox' },
      { title: 'リダイレクト設定', to: 'forms-date-time-picker' },
      { title: 'ASP設定', to: 'forms-editors' },
      { title: '計測タグ', to: 'forms-file-input' },
      { title: 'クロスドメイン設定', to: 'forms-radio' },
    ],
  },
  // {
  //   title: 'Form Elements',
